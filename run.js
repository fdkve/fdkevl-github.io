...
function timeRun(){
    time += 0.001;
    $("#time_box span").text(time.toFixed(3).toString());
...
function isgameover(){
    ...
    clearTimeout(tmp);
    //游戏结束的提示
    $("#box_container").append("<div id='gameover' class='gameover'><p class='over'>游戏结束</p><p class='data'>所用时间</p><p class='data'>" + time.toFixed(3).toString() + "秒</p><p class='data'>本次得分</p><p class='data'>" + score + "分</p><a href='javascript:restartgame();' id='restartgamebutton'>Restart</a></div>");
