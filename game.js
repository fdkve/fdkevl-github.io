...
$(document).bind("click keydown",function(event){
    if(event.type=='click'){
        ...
        // }
            ...
            // else if(btnId == "block-3-"+i){//如何判断敲击是正确的
            //     //说明敲击是正确的
            //     //黑块整体向下移动
            //     if(board[3][i] == 1 && score>0 && score<50){
            //     //黑块整体向下移动
        ...
        // if(btnId == "block-3-0"&&board[3][0] == 1 && score==0){
        //     timeRun();
        //     clearText();
        //     //黑块整体向下移动
        //     moveDown();
        ...
        //     moveDown();
        //  }
        // if(btnId == "block-3-1"&&board[3][1] == 1 && score==0){
        //     timeRun();
        //     clearText();
        //     //黑块整体向下移动
        //     moveDown();
        ...
        // moveDown();
        //  }
        // if(btnId == "block-3-2"&&board[3][2] == 1 && score==0){
        //     timeRun();
        //     clearText();
        //     //黑块整体向下移动
        //     moveDown();
        ...
        // if(btnId == "block-3-3"&&board[3][3] == 1 && score==0){
        //     timeRun();
        //     clearText();
        //     //黑块整体向下移动
        //     moveDown();
